...
const WORK_SITES = new Map([
  ...
  [
    "飞渡API",
    "http://10.10.50.243:8080/samples/locale_zh/main.html?iid=1690894224723&pid=1",
  ],
  ["Mars3D", "http://mars3d.cn/example.html#/ex_0"],
  ["飞渡接口API", "http://10.10.50.243:8080/samples/locale_zh/manager.html"],
  ["飞渡示例文档", "http://10.10.50.243:8080/samples/locale_zh/samples.html#"],
